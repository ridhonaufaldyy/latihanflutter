...
class antrianGigi extends StatefulWidget {
  const antrianGigi({super.key});

  @override
  State<antrianGigi> createState() => _antrianGigiState();
}

class _antrianGigiState extends State<antrianGigi> {
          ...
          children: [
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  QueueItem(status: QueueStatus.pending, queueNumber: 1, patientName: 'Dian'),
                  QueueItem(status: QueueStatus.missed, queueNumber: 2, patientName: 'Eka'),
                  QueueItem(status: QueueStatus.processing, queueNumber: 3, patientName: 'Feri'),
                ],
              ),
            ),
          ],
